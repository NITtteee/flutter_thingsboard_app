...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "actionTypeAssignedFrom租户": MessageLookupByLibrary.simpleMessage(
      "Assigned from 租户",
    ),
    ...
    "actionTypeAssignedTo租户": MessageLookupByLibrary.simpleMessage(
      "Assigned to 租户",
    ),
    ...
    "asset个人资料": MessageLookupByLibrary.simpleMessage("资产配置文件"),
    ...
    "cantDelete用户Account": MessageLookupByLibrary.simpleMessage(
      "Can\\\'t delete user account",
    ),
    "cantLaunch链接地址Link": m5,
    ...
    "confirmTo关闭TheApp": MessageLookupByLibrary.simpleMessage(
    ...
    "device个人资料": MessageLookupByLibrary.simpleMessage("设备配置文件"),
    ...
    "inactive用户AlreadyExists": MessageLookupByLibrary.simpleMessage(
      "未激活用户已存在",
    ),
    "inactive用户AlreadyExistsMessage": MessageLookupByLibrary.simpleMessage(
    ...
    "mark全部AsRead": MessageLookupByLibrary.simpleMessage("全部标记为已读"),
    ...
    "mobileDashboardShouldBeConfiguredInDevice个人资料":
        MessageLookupByLibrary.simpleMessage(
    ...
    "new用户Text": MessageLookupByLibrary.simpleMessage("新用户?"),
    ...
    "password重置": MessageLookupByLibrary.simpleMessage("重置密码"),
    "password重置LinkSuccessfullySentNotification":
        MessageLookupByLibrary.simpleMessage("密码重置链接发送成功！"),
    "password重置Text": MessageLookupByLibrary.simpleMessage(
    ...
    "requestPassword重置": MessageLookupByLibrary.simpleMessage("请求重置密码"),
    ...
    "returnToTheAppAndTap就绪Button": MessageLookupByLibrary.simpleMessage(
    ...
    "select用户": MessageLookupByLibrary.simpleMessage("选择用户"),
    ...
    "tenant个人资料": MessageLookupByLibrary.simpleMessage("租户配置"),
